...
drop trigger if exists app_runtime_config_touch_updated_at
on public.app_runtime_config;

create trigger app_runtime_config_touch_updated_at
...
revoke all on table public.app_runtime_config
